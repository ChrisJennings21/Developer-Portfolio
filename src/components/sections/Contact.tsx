...
export function Contact({ onHover }: ContactProps) {
  ...
  return (
    <section id="contact">
      ...
      <div className="contact-content">
        <p className="contact-description reveal" ref={descRef}>
          I'm always interested in challenging projects and opportunities
          to build impactful software. Whether you have a question or just
          want to say hi, feel free to reach out.
        </p>
        <div className="contact-links reveal" ref={linksRef}>
          <a
            href="mailto:chrisjennings214@gmail.com"
